...
$stmt = $db->prepare("SELECT COUNT(*) FROM jeu");
$stmt->execute();
$jeuxCount = $stmt->fetchColumn();

$stmt = $db->prepare("SELECT COUNT(*) FROM genre");
$stmt->execute();
$genreCount = $stmt->fetchColumn();

$stmt = $db->prepare("SELECT COUNT(*) FROM client");
$stmt->execute();
$clientCount = $stmt->fetchColumn();

$stmt = $db->prepare("SELECT COUNT(*) FROM achat");
$stmt->execute();
$achatCount = $stmt->fetchColumn();
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="addJeuxPage.php" class="dropdown-item">Ajouter Jeux</a>
                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Nombre Total des Jeux</p>
                                <h6 class="mb-0">
                                    <?php echo $jeuxCount; ?>
                                </h6>
                            </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <?php foreach ($achats as $achat) { ?>
                                    <tr>
                                        <td>
                                            <?php echo $achat['idAchat']; ?>
                                        </td>
                                        <td>
                                            <?php echo $achat['cin']; ?>
                                        </td>
                                        <td>
                                            <?php echo $achat['game_id']; ?>
                                        </td>

                                        <td>
                                            <?php echo $achat['purchase_date']; ?>
                                        </td>
