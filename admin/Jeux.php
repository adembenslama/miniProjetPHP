                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 ">
                            ...
                            <a href="Jeux.php" class="dropdown-item active">Lister Jeux</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Liste des Jeux</h6>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="DeleteJeux.php" method="post">
                                                ...
                                                <button type="submit"
                                                    class="btn btn-primary rounded-pill m-2">supprimer</button>
                                            </form>
                                            <form action="updateJeu.php" method="post">
                                                ...
                                                <input type="hidden" name="stock" value="<?php echo $jeu['stock']; ?>">
                                                <button type="submit"
                                                    class="btn btn-warning rounded-pill m-2">modifier</button>
                                            </form>
                                        </td>
                                    </tr>
                                <?php } ?>
