        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="genres.php" class="nav-item nav-link active"><i class="fa fa-th me-2 "></i>Genres</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Liste des Genres</h6>
                ...
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    <form action="AddGenre.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control mb-3" type="text" name="name" placeholder="nom"
                                aria-label="default input example">
